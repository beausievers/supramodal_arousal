function KikiBeaubaExp1()
  ...
  % One shape, two emotions, negative valence.
  % Press 1 or 2 to indicate the corresponding emotion.
  ...
  stimulusSetsFile = 'shapeneg_stimulus_sets.csv';
  % Text file containing index for next stimulus set
  nextStimulusSetFile = 'shapeneg_next_stimulus_set_index.txt'
  ...
  outputRelativePath = 'shapeneg_output/';
  mediaPath = 'media/';
  ...
  function InitializeWindow
    ...
    leftImageCenterX = screenCenterX;
  ...
  function DefineMedia
    ...
    audioFileName = stimulusCsv(stimulusIndex, 2);
  end
  %-----------------------------------------------------------------------------------------------------
  ...
  function WriteHeader
    %header = {'participantId' 'stimulusSet' 'leftImage' 'rightImage' 'audioFile' 'selectedSound' 'responseTime'};
    header = {'participantId' 'stimulusSet' 'leftImage' 'audioFile' 'selectedSound' 'responseTime'};
  ...
  function GetImagePick
    ...
    % After a sound has been selected, record the response.
    selectedSound = character;
    responseTimeSec = toc;
  end
  %-----------------------------------------------------------------------------------------------------
  ...
  function WriteOutputData
    %outData = {participantId stimulusIndex leftImageFileName rightImageFileName audioFileName selectedSound responseTimeSec};
    outData = {participantId stimulusIndex leftImageFileName audioFileName selectedSound responseTimeSec};
